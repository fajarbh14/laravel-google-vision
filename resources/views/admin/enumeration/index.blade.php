...
<h4 class="mb-sm-0 font-size-18">Enumeration</h4>
@endslot
<li class="breadcrumb-item">Enumeration</li>
@slot('action')
    <li><a class="btn btn-primary btn-sm" href="#" onclick="openForm('{{ url('/enumeration/create') }}', 'create')"><i data-feather="plus"></i><span class="me-3"> Create</span></a></li>
    &nbsp;
...
<script>
        var dt;
        var API_URL = "{{ url('/enumeration/api') }}";
