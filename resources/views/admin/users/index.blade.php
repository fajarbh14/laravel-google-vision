...
@slot('action')
    <li><a class="btn btn-primary btn-sm" href="#" onclick="openForm('{{ url('/users/create') }}', 'create')"><i data-feather="plus"></i><span class="me-3"> Create</span></a></li>
    &nbsp;
